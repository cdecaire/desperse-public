...
export function EchoesLoreStory() {
	...
	return (
		<section ref={sectionRef} className="py-20 md:py-32 px-4 md:px-20 nx-bg-surface-lowest nx-section-divider relative" aria-label="Lore">
			<div className="max-w-7xl mx-auto">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-start">
					...
					<div className="space-y-6 font-body nx-text-on-surface-variant text-sm leading-relaxed" data-reveal="left">
						...
						{/* Pull quote — intercepted transmission */}
