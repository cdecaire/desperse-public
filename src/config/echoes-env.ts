...
export const echoesEnv = {
	ECHOES_HELIUS_API_KEY: getEnvVar('ECHOES_HELIUS_API_KEY', '') || getEnvVar('HELIUS_API_KEY', ''),
	...
	PFP_OG_ALLOWLIST_JSON: getEnvVar('PFP_OG_ALLOWLIST_JSON', ''),
	PFP_WL_ALLOWLIST_JSON: getEnvVar('PFP_WL_ALLOWLIST_JSON', ''),
