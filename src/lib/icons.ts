...
export const regularIcons: Record<string, IconDefinition> = {
	...
	"ranking-star": farRankingStar,
	"rocket": farRocket,
	"share-nodes": farShareNodes,
	"shield": farShield,
	...
	"user-group": farUserGroup,
	"user-minus": farUserMinus,
	"user-pen": farUserPen,
	"user-plus": farUserPlus,
	"user-shield": farUserShield,
	"users": farUsers,
