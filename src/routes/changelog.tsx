...
function ChangelogPage() {
  return (
    <StaticPageLayout>
      <article className="max-w-none [&_li]:text-body-lg [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-6">
        <PageHeader
          title="Changelog"
          description="This page highlights recent updates and improvements to Desperse. We're constantly working to make the platform better for creators and collectors."
        >
          <p className="text-body-sm text-muted-foreground">Last updated: April 30, 2026</p>
        </PageHeader>

        <Stack gap={1.5} className="mt-12">
          <Row gap={1} align="center" className="text-heading-2">
          ...
          <Row gap={1} align="center" className="text-heading-2 mt-12">
            <Icon name="sparkles" className="text-muted-foreground" />
            March 2026
          </Row>
